% Construction d'un reservoir pour l'évolution d'une fonction aléatoire
% *********************************************************************
...
%% 2 - Poids
W = sprand(N,N,0.05); W = spfun(@minusPoint5,W); % Poids de récurrence
W_in = 0; % Masque d'entrée
